...
# https://raw.githubusercontent.com/SSHSEDANG4/permission/main/ipmini 
...
clear
wget https://raw.githubusercontent.com/SSHSEDANG4/multiws/main/slowdnss/install-sldns && chmod +x install-sldns && ./install-sldns
clear
